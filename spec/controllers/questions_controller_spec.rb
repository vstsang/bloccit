...
RSpec.describe QuestionsController, type: :controller do
  ...
  describe "POST #create" do
    it "increases the number of question by 1" do
      expect{post :create, question: {title: RandomData.random_sentence, body: RandomData.random_paragraph, resolved: rand(0..1) == 1 ? true : false}}.to change(Question,:count).by(1)
    end

    it "assigns the new question to @question" do
      post :create, question: {title: RandomData.random_sentence, body: RandomData.random_paragraph, resolved: rand(0..1) == 1 ? true : false}
  ...
  describe "PUT #update" do
    it "updates question with expected attributes" do
      ...
      new_resolved = (rand(0..1) == 1 ? true : false)
